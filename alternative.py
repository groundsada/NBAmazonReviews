...
print('\nLoading the dataset...\nThe dataset is huge so this may take a few minutes...')
try: 
    if os.path.exists('input/test.ft.txt.bz2') and os.path.exists('input/train.ft.txt.bz2'):
        ...
        os.system('kaggle datasets download -d bittlingmayer/amazonreviews')
...
print('\nLoading the bz2 files...\nThe files are huge and compressed...\nThis may take a few minutes...')
try:
    train_file = bz2.BZ2File('input/train.ft.txt.bz2')
except:
    print('\n\nERROR! Kaggle is unable to fetch the dataset...Please configure the kaggle API or download the dataset, and extract it and put the 2 bz2 files in the input folder...\n\n')
    raise Exception('Dataset not found. Please download OR USE the original python program')
...
print('Finished loading the bz2 files...\nPreprocessing dataset...')
